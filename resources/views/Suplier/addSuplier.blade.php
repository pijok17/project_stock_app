                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-4 form-outline">
                                        ...
                                        <input type="text" value="{{ old('name_suplier') }}" name="name_suplier" id="name_suplier" class="form-control @error('nama_suplier') is-invalid @enderror" placeholder="Nama Suplier..."/>
                                        @error('name_suplier')
